$('document').ready(function() {
	...
	$('a[name=c5]').click(function(evt) {
		...
		if(confirm('Are you sure you want to delete this lineup? ALL items and logs in this lineup will be deleted as well') == true) {
	...
	$('form[name=searchf]').submit(function(evt) {
		...
		$.post('ejuice.php', {
			...
			if(data == '3') {
				$('.loader').fadeOut(200);
				location.href = 'ejuice.php?search='+encodeURIComponent(val);
				return false;
			}
			if(data == '2') {
				$('.loader').fadeOut(200);
