...
<div id="header">
		...
		<div id="menu">
			<ul id="menuli">
				...
				<a href="#" title="Items" class="dropbtn2"><i class="fa fa-list-ul"></i> Items</a></li>
					<div id="myDropdown" class="dropdown-content">
                            	<li>
                                    <ul><a href="items.php?ejuice=1">Low Mint</a></ul>
                                    <ul><a href="items.php?ejuice=2">No-Menthol</a></ul>
                                    <ul><a href="items.php?ejuice=4">Yummy</a></ul>
                                 </li>  
                           </div> 
				...
				<a href="#" title="Categories"><i class="fa fa-folder"></i> Categories</a></li>
				 <div id="myDropdown" class="dropdown-content">
                            	<li>
                                    <ul><a href="categories.php?page=1">Item</a></ul>
                                    <ul><a href="ejuice.php?page=2">Lineup Series</a></ul>
