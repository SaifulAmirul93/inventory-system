...
$_titles = array('','Home','New Item','Items','Check-In Item','Check-Out Item','Logs','Categories','New Category','Users','New User','Edit user','Settings','Edit Item','Edit Category','Category Details','Item Details','User Details','Lineup Series','New Lineup Series');
...
?>
	...
	<title>Nasty Juice Inventory - <?php echo $_title; ?></title>
...
switch($_page) {
	...
	case 18: echo '	<script type="text/javascript" src="media/js/ejuice.js"></script>'; break;

	case 19: echo '	<script type="text/javascript" src="media/js/new-ejuice.js"></script>'; break;
} ?>