...
$_titles = array('','Home','New Item','Items','Check-In Item','Check-Out Item','Logs','Categories','New Category','Users','New User','Edit user','Settings','Edit Item','Edit Category','Category Details','Item Details','User Details');
