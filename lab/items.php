	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				<a href="" name="check-out-all" class="btn blue disabled fright"><i class="fa fa-print"></i>Print</a>
			</div>
...
?>
					...
					?>   
						<td><input type="checkbox" name="chbox" value="<?php echo $item->id; ?>" /></td>
						<td class="hover" data-type="id" style="color:#F12241;"><?php echo $item->id; ?></td>
						<td class="hover" data-type="name" style="color:#F12241;"><?php echo $item->name; ?></td>
						<td class="hover" data-type="cat" style="color:#F12241;"><?php echo $_items->get_category_name($item->category); ?></td>
						<td style="color:#F12241;"><?php echo $item->qty; ?></td>
						<td style="color:#F12241;"><?php echo $_items->parse_price($item->price); ?></td>
						<td>
							<a href="" name="c1" title="Check-In"><i class="fa fa-arrow-down"></i></a>
							<a href="" name="c2" title="Check-Out"><i class="fa fa-arrow-up"></i></a>
							<?php
