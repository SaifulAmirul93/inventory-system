...
//		$s=false;
//		$logs = $_logs->get_logs($type,$page, $pp, $itemid, $catid);
		...
		<div class="wrapper-pad">
			...
			?>
             <div style="text-align:right">
                ...
                &nbsp;&nbsp;
                <a href="#" id="open_print" class="button" onclick="open_print('div1','logs')"><i class="fa fa-print fa-lg" aria-hidden="true" style="color:#FFF"></i>   Print All</a>
                </div>
