...
class Items {
	...
	public function get_items($type,$page, $items_per_page) {
		...
		$res = $this->query("SELECT * FROM invento_items WHERE category = $type ORDER BY id desc LIMIT $x,$y", 'get_items()');
		return $res;
	}

	public function get_items2($page, $items_per_page) {
		$page = stripslashes($page);
		$items_per_page = stripslashes($items_per_page);
	...
	public function count_items() {
		...
		public function count_items_label50() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 1", 'count_items_label50()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
		public function count_items_label10() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 2", 'count_items_label10()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
	
		public function count_items_box50() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 3", 'count_items_box50()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
			public function count_items_box10() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 4", 'count_items_box10()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
		public function count_items_bottle() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 5", 'count_items_bottle()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
	public function count_items_boxpack() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 6", 'count_items_boxpack()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
	public function count_items_merchandise() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 7", 'count_items_merchandise()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
		public function count_items_others() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 8", 'count_items_others()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
		public function count_items_marketing() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 9", 'count_items_marketing()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
		public function count_items_daging() {
		$res = $this->query("SELECT SUM(qty) AS s FROM invento_items WHERE category = 10", 'count_items_daging()');
		$obj = $res->fetch_object();
		return $obj->s;
	}
