...
$dbhost = 'nstylab.com';		// Write your MySQL host here.
$dbuser = 'nstylabc_jauhred';	// Write your MySQL User here.
$dbpass = '#@!321EWQewq';	// Write your MySQL Password here.
$dbname = 'nstylabc_inventory';		// Write the MySQL Database where you want to install Invento
